          ...
          <React.Fragment key={step}>
            ...
            <div
              ...
              ${
                ...
                : isActive
                ? "bg-[#4f63a1] border border-[#5B6DA8] shadow-[0_0_8px_rgba(70,87,138,0.7),0_0_18px_rgba(70,87,138,0.85)] text-white"
            ...
            {index < steps.length - 1 && (
              <div
                className={`w-6 sm:w-10 md:w-12 h-0.5 mx-1 transition-colors
                  ${step < currentStep ? "bg-linear-to-r from-[#5d76ca] to-[#34416d]"
                    : "bg-gray-700"}
                `}
              />
            )}
